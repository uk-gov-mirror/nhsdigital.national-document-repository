...
def validate_lg_files(
    ...
    for doc in file_list:
        check_for_number_of_files_match_expected(doc.fileName, len(file_list))
        validate_lg_file_type(doc.contentType)
        checks_per_filename(doc.fileName, nhs_number)
        files_name_list.append(doc.fileName)
