...
def lambda_handler(event, context):
    ...
    doc_upload_iteration2_enabled = FeatureFlagService().get_feature_flags_by_flag(FeatureFlags.UPLOAD_DOCUMENT_ITERATION_2_ENABLED)
    doc_status_filter = {'doc_status': 'final'} if doc_upload_iteration2_enabled else None
