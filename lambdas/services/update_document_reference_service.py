...
from utils.lloyd_george_validator import getting_patient_info_from_pds, validate_lg_files_for_access_and_store
...
class UpdateDocumentReferenceService:
    ...
    def update_document_reference_request(
        ...
        try:
            ...
            validate_lg_files_for_access_and_store([update_request_document], pds_patient_details)
            ...
            url_responses[update_request_document.client_id] = fhir_response_data["content"][0]["attachment"]["url"]
