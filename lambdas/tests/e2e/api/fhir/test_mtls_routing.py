...
FOOBAR_CLIENT_CERT_PATH = os.environ.get("FOOBAR_CLIENT_CERT_PATH")
FOOBAR_CLIENT_KEY_PATH = os.environ.get("FOOBAR_CLIENT_KEY_PATH")


def test_mtls_invalid_common_name():
    record_id = str(uuid.uuid4())
    response = get_pdm_document_reference(
        record_id, FOOBAR_CLIENT_CERT_PATH, FOOBAR_CLIENT_KEY_PATH
    )
