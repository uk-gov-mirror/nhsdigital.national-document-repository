...
def test_valid_input_returns_presigned_url(
    ...
    mock_service.fhir_doc_service.document_service.fetch_documents_from_table.return_value = [mock_document_reference]
    mock_service.fhir_doc_service.s3_service.create_download_presigned_url.return_value = mock_presigned_s3_url
