...
MOCK_DOCUMENT_REVIEW_DYNAMODB_NAME = "DOCUMENT_REVIEW_DYNAMODB_NAME"
MOCK_PENDING_REVIEW_BUCKET_NAME = "PENDING_REVIEW_BUCKET_NAME"
...
MOCK_PENDING_REVIEW_BUCKET = "test_review_bucket"
MOCK_DOCUMENT_REVIEW_DYNAMOODB_TABLE_NAME = "test_review_table"
...
def set_env(monkeypatch):
    ...
    monkeypatch.setenv(MOCK_DOCUMENT_REVIEW_DYNAMODB_NAME, MOCK_DOCUMENT_REVIEW_DYNAMOODB_TABLE_NAME)
    monkeypatch.setenv(MOCK_PENDING_REVIEW_BUCKET_NAME, MOCK_PENDING_REVIEW_BUCKET)
