...
MOCK_ORGANISATION_DATA_1 = OrganisationData(
    ...
    daily_user_ids_accessed_review=["user3", "user4"],
    daily_user_ids_accessed_deceased_patient=["user3"],
    daily_user_ids_reviewed=["user1"],
    daily_user_ids_reassigned=["user2"],
)
MOCK_ORGANISATION_DATA_2 = OrganisationData(
    ...
    daily_user_ids_uploaded=["user3"],
    daily_user_ids_accessed_review=["user1", "user2"],
    daily_user_ids_accessed_deceased_patient=["user3"],
    daily_user_ids_reviewed=["user5", "user6", "user7"],
    daily_user_ids_reassigned=["user3"],
)
MOCK_ORGANISATION_DATA_3 = OrganisationData(
    ...
    daily_count_ods_report_requested=2,
    daily_count_ods_report_created=2,
    daily_user_ids_uploaded=["user3", "user4"],
    daily_user_ids_accessed_review=["user3"],
    daily_user_ids_accessed_deceased_patient=["user1", "user3"],
    daily_user_ids_reviewed=["user3"],
    daily_user_ids_reassigned=["user2", "user4"],
)
    ...
    [
        {
            ...
            "weekly_count_users_uploaded": 2,
            "weekly_count_users_reviewed": 1,
            "weekly_count_users_reassigned": 1,
            "weekly_count_users_accessing_review": 2,
            "weekly_count_users_accessing_deceased": 1,
        ...
        {
            "ods_code": "Y12345",
            "weekly_count_upload": 0 + 2,
            "weekly_count_viewed": 15 + 30,
            "weekly_count_downloaded": 1 + 5,
            "weekly_count_deleted": 1 + 1,
            "weekly_count_searched": 0,
            "weekly_count_users_uploaded": 2,
            "weekly_count_users_reviewed": 4,
            "weekly_count_users_reassigned": 3,
            "weekly_count_users_accessing_review": 3,
            "weekly_count_users_accessing_deceased": 2,
...
SERIALISED_ORGANISATION_DATA = [
    {
        ...
        "DailyUserIdsUploaded": ["user1", "user2"],
        "DailyUserIdsAccessedReview": ["user3", "user4"],
        "DailyUserIdsAccessedDeceasedPatient": ["user3"],
        "DailyUserIdsReviewed": ["user1"],
        "DailyUserIdsReassigned": ["user2"],
    ...
    },
    {
        ...
        "DailyUserIdsUploaded": ["user3"],
        "DailyUserIdsAccessedReview": ["user1", "user2"],
        "DailyUserIdsAccessedDeceasedPatient": ["user3"],
        "DailyUserIdsReviewed": ["user5", "user6", "user7"],
        "DailyUserIdsReassigned": ["user3"],
    ...
    },
    {
        ...
        "DailyCountOdsReportRequested": 2,
        "DailyCountOdsReportCreated": 2,
        "DailyUserIdsUploaded": ["user3", "user4"],
        "DailyUserIdsAccessedReview": ["user3"],
        "DailyUserIdsAccessedDeceasedPatient": ["user1", "user3"],
        "DailyUserIdsReviewed": ["user3"],
        "DailyUserIdsReassigned": ["user2", "user4"],
    ...
    [
        {
            ...
            "Weekly count users accessing deceased": 1,
            "Weekly count users accessing review": 2,
            "Weekly count viewed": 35,
            "Weekly count downloaded": 4,
            "Weekly count users uploaded": 2,
            "Weekly count users reviewed": 1,
            "Weekly count users reassigned": 1,
            "Weekly count deleted": 1,
            "Weekly count ods report requested": 10,
            "Weekly count ods report created": 0,
            "Weekly count upload review": 0,
            "Weekly count upload": 0,
