...
describe('Upload Document Requests', () => {
    ...
    describe('uploadDocumentToS3', () => {
        ...
        it('should upload File', async () => {
            ...
            const [s3Url, file] = mockedAxios.post.mock.calls[0];
    ...
    describe('generateStitchedFileName', () => {
        const docConfig = {
        ...
        it('throws an error when patient details is null', () => {
            expect(() => generateStitchedFileName(null, {} as DOCUMENT_TYPE_CONFIG)).toThrow(
