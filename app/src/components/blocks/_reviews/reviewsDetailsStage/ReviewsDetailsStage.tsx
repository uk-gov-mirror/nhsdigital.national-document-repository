...
const ReviewsDetailsStage = ({
    ...
    const onYesSelectionSuccess = (): void => {
        ...
        if (
            ...
            navigateUrlParam(routeChildren.REVIEW_UPLOAD, { reviewId }, navigate);
            return;
        }
        ...
        navigateUrlParam(routeChildren.REVIEW_ASSESS_FILES, { reviewId }, navigate);
    };
    ...
    const submit = (data: FormData): void => {
        ...
        if (data.acceptDocument === 'yes') {
            ...
            navigateUrlParam(routeChildren.REVIEW_SEARCH_PATIENT, { reviewId }, navigate);
        }
    };
