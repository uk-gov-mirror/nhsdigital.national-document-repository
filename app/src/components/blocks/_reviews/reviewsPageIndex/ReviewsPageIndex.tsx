...
export type ReviewsPageIndexProps = {
                    ...
                    return (
                        <Table.Row key={review.id}>
                            ...
                            <Table.Cell className="nowrap">
                                <Link
                                    to={routeChildren.REVIEW_DETAIL.replace(
                                        ':reviewId',
                                        getReviewNavigationFormat(review.id, review.version),
                                    )}
...
const ReviewsPageIndex = ({ setReviewData }: ReviewsPageIndexProps): React.JSX.Element => {
...
export default ReviewsPageIndex;
