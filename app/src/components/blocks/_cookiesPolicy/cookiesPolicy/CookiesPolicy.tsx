...
const CookiePolicy = (): React.JSX.Element => {
    ...
    const updatePreferences: SubmitHandler<FormData> = async (formData) => {
        const isConsentGiven = formData.analyticsConsent === ConsentOptions.YES;
        window.NHSCookieConsent.setStatistics(isConsentGiven);
            ...
            <Details>
                ...
                <Details.Text>
                    <Table>
                        ...
                        <Table.Body>
                            <Table.Row>
                                <Table.Cell>cwr_s</Table.Cell>
                                <Table.Cell>
                                    When you close the browser, or after 30 minutes of inactivity.
                                </Table.Cell>
                            </Table.Row>
                            <Table.Row>
                                <Table.Cell>cwr_u</Table.Cell>
                                <Table.Cell>
                                    When you close the browser, or 30 days after you logged in.
                                </Table.Cell>
                            </Table.Row>
                        </Table.Body>
                    </Table>
