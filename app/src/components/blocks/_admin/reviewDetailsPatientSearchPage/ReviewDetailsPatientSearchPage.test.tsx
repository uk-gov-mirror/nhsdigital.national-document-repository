...
import ReviewDetailsPatientSearchPage, {
    incorrectFormatMessage,
} from './ReviewDetailsPatientSearchPage';
...
describe('ReviewDetailsPatientSearchPage', () => {
    ...
    describe('Rendering', () => {
        it('renders page heading', () => {
            render(<ReviewDetailsPatientSearchPage reviewSnoMed="test" />);
    ...
    describe('Props', () => {
        it('accepts reviewSnoMed prop', () => {
            const reviewSnoMed = 'test-snomed-code';
            render(<ReviewDetailsPatientSearchPage reviewSnoMed={reviewSnoMed} />);
